...
<?= $this->section('title-meta'); ?>
  <title>Kategori <?= $kategoriDetail['nama']; ?> | BPBD - KALTIM</title>
  <meta name="description" content="Kategori <?= $kategoriDetail['nama']; ?> BPBD Provinsi Kalimantan Timur, BPBD Provinsi Kaltim, BPBD Kaltim, bencana, banjir, kebakaran hutan dan lahan, tanah longsor, gempa bumi, gunung meletus">
