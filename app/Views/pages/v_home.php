...
<head>
	...
	<!-- Bootstrap -->
	<link rel="stylesheet" href="<?= base_url('pages_assets/css/bootstrap.min.css'); ?>">
	<!-- Template styles-->
	<link rel="stylesheet" href="<?= base_url('pages_assets/css/style.css'); ?>">
	<!-- Responsive styles-->
	<link rel="stylesheet" href="<?= base_url('pages_assets/css/responsive.css'); ?>">
	<!-- FontAwesome -->
	<link rel="stylesheet" href="<?= base_url('pages_assets/css/font-awesome.min.css'); ?>">
	<!-- Animation -->
	<link rel="stylesheet" href="<?= base_url('pages_assets/css/animate.css'); ?>">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="<?= base_url('pages_assets/css/owl.carousel.min.css'); ?>">
									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="https://bpbd.kaltimprov.go.id/about">Sejarah BPBD Kaltim</a></li>
												<li><a href="team.html">Visi & Misi BPBD Kaltim</a></li>
												<li><a href="testimonials.html">Tugas & Fungsi</a></li>
												<li><a href="faq.html">Struktur Organisasi</a></li>
											</ul>
										</li>

										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">Layanan <i
													class="fa fa-angle-down"></i></a>
											<ul class="dropdown-menu" role="menu">
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">Informasi Publik <i
													class="fa fa-angle-down"></i></a>
											<ul class="dropdown-menu" role="menu">
												<li><a href="typography.html">Publikasi</a></li>
												<li><a href="404.html">Kerjasama</a></li>
												<li><a href="404.html">Produk Hukum</a></li>
												<li class="dropdown-submenu">
													<a href="#.">Sub Double Menu</a>
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">Pengetahuan Bencana <i
													class="fa fa-angle-down"></i></a>
											<ul class="dropdown-menu" role="menu">
												<li><a href="news-left-sidebar.html">Definisi Bencana</a></li>
												<li><a href="news-right-sidebar.html">Potensi Ancaman Bencana</a></li>
												<li><a href="news-single.html">Sistem Penanggulangan Bencana</a></li>
											</ul>
										</li>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?= base_url('pages_assets/images/icon-image/service-icon1.png'); ?>" alt="" />
							</div>
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?= base_url('pages_assets/images/icon-image/service-icon2.png'); ?>" alt="" />
							</div>
							<div class="ts-service-box-info">
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?= base_url('pages_assets/images/icon-image/service-icon3.png'); ?>" alt="" />
							</div>
							<div class="ts-service-box-info">
					...
					<div class="col-md-4 text-center">
						<img class="service-center-img img-responsive" src="<?= base_url('pages_assets/images/services/service-center.jpg'); ?>" alt="" />
					</div><!-- Col end -->

					<div class="col-md-4">
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?= base_url('pages_assets/images/icon-image/service-icon4.png'); ?>" alt="" />
							</div>
							<div class="ts-service-box-info">
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?= base_url('pages_assets/images/icon-image/service-icon5.png'); ?>" alt="" />
							</div>
							<div class="ts-service-box-info">
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?= base_url('pages_assets/images/icon-image/service-icon6.png'); ?>" alt="" />
							</div>
							<div class="ts-service-box-info">
					...
					<div id="isotope" class="isotope">
						<div class="col-md-4 col-sm-6 col-xs-12 commercial isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?= base_url('pages_assets/images/projects/project1.jpg'); ?>">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/projects/project1.jpg'); ?>" alt="">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 healthcare isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?= base_url('pages_assets/images/projects/project2.jpg'); ?>">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/projects/p'); ?>roject2.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 government isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?= base_url('pages_assets/images/projects/project3.jpg'); ?>">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/projects/p'); ?>roject3.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 education isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?= base_url('pages_assets/images/projects/project4.jpg'); ?>">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/projects/p'); ?>roject4.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 infrastructure isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?= base_url('pages_assets/images/projects/project5.jpg'); ?>">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/projects/p'); ?>roject5.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 residential isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?= base_url('pages_assets/images/projects/project6.jpg'); ?>">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/projects/p'); ?>roject6.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div id="testimonial-slide" class="owl-carousel owl-theme testimonial-slide">
							<div class="item">
								<div class="quote-item">
									...
									<div class="quote-item-footer">
										<img class="testimonial-thumb" src="<?= base_url('pages_assets/images/clients/testimonial1.png'); ?>" alt="testimonial">
							...
							<div class="item">
								<div class="quote-item">
									...
									<div class="quote-item-footer">
										<img class="testimonial-thumb" src="<?= base_url('pages_assets/images/clients/testimonial2.png'); ?>" alt="testimonial">
										<div class="quote-item-info">
							...
							<div class="item">
								<div class="quote-item">
									...
									<div class="quote-item-footer">
										<img class="testimonial-thumb" src="<?= base_url('pages_assets/images/clients/testimonial3.png'); ?>" alt="testimonial">
										<div class="quote-item-info">
						...
						<div class="row all-clients">
							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?= base_url('pages_assets/images/clients/client'); ?>1.png" alt="" /></a>
								</figure>
							</div><!-- Client 1 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?= base_url('pages_assets/images/clients/client'); ?>2.png" alt="" /></a>
								</figure>
							</div><!-- Client 2 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?= base_url('pages_assets/images/clients/client'); ?>3.png" alt="" /></a>
								</figure>
							</div><!-- Client 3 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?= base_url('pages_assets/images/clients/client'); ?>4.png" alt="" /></a>
								</figure>
							</div><!-- Client 4 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?= base_url('pages_assets/images/clients/client'); ?>5.png" alt="" /></a>
								</figure>
							</div><!-- Client 5 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?= base_url('pages_assets/images/clients/client'); ?>6.png" alt="" /></a>
								</figure>
							</div><!-- Client 6 end -->
				...
				<div class="row">
						...
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/news/n'); ?>ews1.jpg" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
					...
					<div class="col-md-4 col-xs-12">
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/news/n'); ?>ews2.jpg" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
					...
					<div class="col-md-4 col-xs-12">
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?= base_url('pages_assets/images/news/n'); ?>ews3.jpg" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-12 footer-widget footer-about">
							...
							<img class="footer-logo" src="<?= base_url('pages_assets/images/footer'); ?>-logo.png" alt="" />
