...
<?= $this->section('title-meta'); ?>
  <title><?= $produkhukum['nama']; ?> | BPBD - KALTIM</title>
  <meta name="description" content="<?= $produkhukum['nama']; ?> BPBD Provinsi Kalimantan Timur, BPBD Provinsi Kaltim, BPBD Kaltim, bencana, banjir, kebakaran hutan dan lahan, tanah longsor, gempa bumi, gunung meletus">
