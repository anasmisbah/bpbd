...
<?= $this->section('content-header'); ?>
    ...
    <div class="col-sm-6">
        ...
        <li class="breadcrumb-item"><a href="<?= route_to('layanan.detail'); ?>">Pelayanan</a></li>
            <li class="breadcrumb-item active">Layanan - Layanan</li>
        </ol>
    </div><!-- /.col -->
<?= $this->endSection(); ?>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Data Layanan BPBD</h3>
        <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
            <li class="nav-item">
                <a class="nav-link active" href="<?= route_to('itemlayanan.create'); ?>"><i class="fas fa-plus"></i></a>
            </li>
            </ul>
        </div>
        </div>
        ...
        <table id="example2" class="table table-bordered table-striped">
            ...
            <tbody>
            <?php $i = 1; ?>
            <?php foreach($itemlayanan as $item): ?>
            <tr>
                <td><?= $i++; ?></td>
                <td><?= implode(' ', array_slice(explode(' ', $item['judul']), 0, 6)).'...'; ?></td>
                <td><?= implode(' ', array_slice(explode(' ', $item['deskripsi']), 0, 6)).'...'; ?></td>
                <td>
                    <a href="<?= route_to('itemlayanan.edit',$item['id']); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="javascript:;" data-action="<?= route_to('itemlayanan.delete'); ?>" data-item_id="<?= $item['id']; ?>" class="btn btn-sm btn-danger btn-delete">
                        <i class="fas fa-trash"></i>
                    </a>
                    <a href="<?= route_to('itemlayanan.detail',$item['id']); ?>" class="btn btn-info btn-sm">
