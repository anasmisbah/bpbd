    ...
    <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Mengubah Layanan</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?= route_to('itemlayanan.update'); ?>" method="POST" enctype="multipart/form-data">
                  <?= csrf_field(); ?>
                  <input type="hidden" name="id" value="<?= $itemlayanan['id']; ?>">
                  <input type="hidden" name="gambarLama" value="<?= $itemlayanan['gambar']; ?>">
                  <div class="card-body">
                    <div class="form-group row">
                            <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input autofocus value="<?= old('judul')?old('judul'):$itemlayanan['judul']; ?>" type="text" class="form-control <?= ($validation->hasError('judul'))? 'is-invalid':'' ?>" id="judul" name="judul" placeholder="Judul itemlayanan">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-lg-6 col-md-6">
                          <textarea id="deskripsi" class="form-control <?= ($validation->hasError('deskripsi'))? 'is-invalid':'' ?>" id="deskripsi" name="deskripsi"><?= old('deskripsi')?old('deskripsi'):$itemlayanan['deskripsi']; ?></textarea>
                          <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-lg-6 col-md-6">
                            <img class="img-thumbnail mb-2" id="image_con" width="250px" src="<?= base_url('uploads/'.$itemlayanan['gambar']); ?>" alt="">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="<?= route_to('itemlayanan.index'); ?>" class="btn btn-default">Kembali</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
