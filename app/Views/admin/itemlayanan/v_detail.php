    ...
    <div class="card-header">
        ...
        <div class="card-tools">
          <ul class="nav nav-pills ml-auto">
            <li class="nav-item">
                <a class="nav-link btn-warning active mr-1" href="<?= route_to('itemlayanan.edit',$itemlayanan['id']); ?>"><i class="fas fa-edit"></i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link btn-danger active" href="<?= route_to('itemlayanan.index'); ?>"><i class=" fas fa-times"></i></a>
            </li>
          </ul>
        </div>
    </div>
    ...
    <table class="table table-striped">
            <tbody>
              <tr>
                ...
                <td><?= $itemlayanan['judul']; ?></td>
              </tr>
              <tr>
                <td style="width:10%">Deskripsi</td>
                <td><?= $itemlayanan['deskripsi']; ?></td>
              </tr>
              <tr>
                <td style="width:10%">Gambar</td>
                <td><a href="<?= base_url('uploads/'.$itemlayanan['gambar']); ?>" class="foto"><img src="<?= base_url('uploads/'.$itemlayanan['gambar']); ?>" alt="" class="img-thumbnail" width="100px"></a></td>
              </tr>
              <tr>
            </tbody>
          </table>
...
<script>
$(function () {
  let createdAtDate = '<?= $itemlayanan['created_at']; ?>'
  let updatedAtDate = '<?= $itemlayanan['updated_at']; ?>'
