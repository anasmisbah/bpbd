    ...
    <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Mengubah Pengetahuan Bencana</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?= route_to('bencana.update'); ?>" method="POST" enctype="multipart/form-data">
                  <?= csrf_field(); ?>
                  <input type="hidden" name="id" value="<?= $bencana['id']; ?>">
                  <input type="hidden" name="slug" value="<?= $bencana['slug']; ?>">
                  <div class="card-body">
                    <div class="form-group row">
                            <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input autofocus value="<?= old('judul')?old('judul'):$bencana['judul']; ?>" type="text" class="form-control <?= ($validation->hasError('judul'))? 'is-invalid':'' ?>" id="judul" name="judul" placeholder="Judul">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-lg-10 col-md-10">
                          <textarea id="deskripsi" class="form-control <?= ($validation->hasError('deskripsi'))? 'is-invalid':'' ?>" id="deskripsi" name="deskripsi"><?= old('deskripsi')?old('deskripsi'):$bencana['deskripsi']; ?></textarea>
                          <span class="invalid-feedback" role="alert">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="<?= route_to('bencana.detail',$bencana['id']); ?>" class="btn btn-default">Kembali</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
