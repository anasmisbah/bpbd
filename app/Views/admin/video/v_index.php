...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?= route_to('video.create'); ?>"><i class="fas fa-plus"></i></a>
            </li>
            </ul>
        </div>
        </div>
        ...
        <table id="example2" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    <a href="<?= route_to('video.edit',$item['id']); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="javascript:;" data-action="<?= route_to('video.delete'); ?>" data-item_id="<?= $item['id']; ?>" class="btn btn-sm btn-danger btn-delete">
                        <i class="fas fa-trash"></i>
                    </a>
                    <a href="<?= route_to('video.detail',$item['id']); ?>" class="btn btn-info btn-sm">
