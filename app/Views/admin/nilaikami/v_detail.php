...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Detail Nilai kami</h3>
        <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
            <li class="nav-item">
                <a class="nav-link btn-warning active mr-1" href="<?= route_to('nilaikami.edit',$nilaikami['id']); ?>"><i class="fas fa-edit"></i></a>
            </li>
            <li class="nav-item">
            <a class="nav-link btn-danger active" href="<?= route_to('nilaikami.index'); ?>"><i class=" fas fa-times"></i></a>
              </li>
            </ul>
        </div>
    </div>
    ...
    <table class="table table-striped">
            <tbody>
              <tr>
                ...
                <td><?= $nilaikami['judul']; ?></td>
              </tr>
              <tr>
                <td style="width:10%">Deskripsi</td>
                <td><?= $nilaikami['deskripsi']; ?></td>
              </tr>
            </tbody>
          </table>
        </div>
...
<script>
$(function () {
  let createdAtDate = '<?= $nilaikami['created_at']; ?>'
  let updatedAtDate = '<?= $nilaikami['updated_at']; ?>'
