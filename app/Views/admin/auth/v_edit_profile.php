...
<?= $this->section('content-header'); ?>
    ...
    <div class="col-sm-6">
        ...
        <li class="breadcrumb-item"><a href="<?= route_to('pengguna.profile'); ?>">Profile</a></li>
    ...
    <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Mengubah Profile Pengguna</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?= route_to('user.update'); ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="password" class="form-control <?= ($validation->hasError('password'))? 'is-invalid':'' ?>" id="password" name="password" placeholder="password user">
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="password" class="form-control <?= ($validation->hasError('password_confirm'))? 'is-invalid':'' ?>" id="password_confirm" name="password_confirm" placeholder="password_confirm">
                                <span class="invalid-feedback" role="alert">
