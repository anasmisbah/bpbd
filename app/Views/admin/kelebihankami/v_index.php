...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Data Kelebihan BPBD</h3>
        <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
            <li class="nav-item">
                <a class="nav-link active" href="<?= route_to('kelebihankami.create'); ?>"><i class="fas fa-plus"></i></a>
            </li>
            </ul>
        </div>
        </div>
        ...
        <table id="example2" class="table table-bordered table-striped">
            ...
            <tbody>
            <?php $i = 1; ?>
            <?php foreach($kelebihankami as $item): ?>
            <tr>
                <td><?= $i++; ?></td>
                <td><?= $item['judul']; ?></td>
                <td><i class="fas fa-<?= $item['icon']; ?>"></i></td>
                <td>
                    <a href="<?= route_to('kelebihankami.edit',$item['id']); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="javascript:;" data-action="<?= route_to('kelebihankami.delete'); ?>" data-item_id="<?= $item['id']; ?>" class="btn btn-sm btn-danger btn-delete">
