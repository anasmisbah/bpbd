...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?= route_to('gallery.create'); ?>"><i class="fas fa-plus"></i></a>
            </li>
            </ul>
        </div>
        </div>
        ...
        <table id="example2" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-action="<?= route_to('gallery.post.delete'); ?>" data-item_id="<?= $item['id']; ?>" class="btn btn-sm btn-danger btn-delete">
                        <i class="fas fa-trash"></i>
                    </a>
                    <a href="<?= route_to('gallery.detail',$item['id']); ?>" class="btn btn-info btn-sm">
